...
static DEFAULT_METADATA_READ_CHUNK_SIZE: usize = 50;

// The default maximum number of threads to read metadata when using the file
// based object ID reader.
pub const DEFAULT_MAX_METADATA_READ_THREADS: usize = 50;
...
pub struct ConfigOptions {
    ...
    pub max_metadata_read_threads: usize,
}
...
impl Default for ConfigOptions {
    fn default() -> ConfigOptions {
        ConfigOptions {
            ...
            max_metadata_read_threads: DEFAULT_MAX_METADATA_READ_THREADS,
        }
    }
}
